...
(TRAVEL_NO, TITLE, COUNTRY, START_DATE, END_DATE, COMPANION)
VALUES 
(SEQ_TRAVEL_INFO_NO.NEXTVAL, '나의 첫 유럽 여행', '프랑스, 스위스', TO_DATE('2025-12-01','YYYY-MM-DD'), TO_DATE('2025-12-10','YYYY-MM-DD'), '혼자');
